...
urlpatterns = [
    ...
    path('review/<int:pk>/comment/update/', CommentUpdateView.as_view(), name = 'comment-update'),
    path('review/<int:pk>/comment/delete/', CommentDeleteView.as_view(), name = 'comment-delete'),
